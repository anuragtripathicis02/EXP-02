...
const TransectionHistoryPaidForASession = ({ show, handleClose }: any) => {
  return (
            ...
            <Modal.Body className="common-modal-body modal-booking bg-green">
                ...
                <div className='session-summery position-relative z-1'>
                    ...
                    <div className="modal-details">
                        <ul>
                            <li>
                                <span className='cont-left'>Scheduled For</span>
                                <span className='cont-right'>Dec 29, 2025</span>
                            </li>
                            <li>
                                <span className='cont-left'>Session Time</span>
                                <span className='cont-right'>10:00 AM - 11:00 AM</span>
                            </li>
                            <li>
                                <span className='cont-left'>Session Duration</span>
                                <span className='cont-right'>1 Hrs</span>
                            </li>
                        </ul>
                    </div>
                </div>
...
export default TransectionHistoryPaidForASession
