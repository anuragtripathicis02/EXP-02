...
const ConfirmationBeforePayment = ({ show, handleClose, openNext = () => { } }: Props) => {
  return (
    <Modal size="sm" show={show} onHide={handleClose} centered className="common-modal">
            ...
            <Modal.Body className="common-modal-body">
                <p className='font-20'>
                    You are about to be charged <b>$1568.00</b> for buying <b>1568 EXP</b> Coins, which will be added to your in app wallet. <br></br>
                </p>
                <p className='font-20 mb-0'>Please confirm your purchase to continue.</p>
            </Modal.Body>
...
export default ConfirmationBeforePayment
