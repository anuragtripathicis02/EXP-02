...
const CoinsAddedSuccessfully = ({ show, handleClose }: any) => {
    return (
                <Modal size="sm" show={show} onHide={handleClose} centered className="common-modal">
                    ...
                    <Modal.Body className="common-modal-body modal-booking bg-green">
                        ...
                        <div className="modal-top text-center text-white position-relative z-1">
                            ...
                            <h2 className='text-white'>Coins Added!</h2>
                            <p className='text-white'>Great! Your payment was successful and we have added <b>1568 EXP Coins</b> to your wallet </p>
                        </div>
                        <div className='modal-card position-relative z-1'>
                            <div className='modal-white-card'>
                                <div className="modal-details">
                                    <ul>
                                        ...
                                        <li>
                                            <span className='cont-left'>Pay Mode</span>
                                            <span className='cont-right black'>Visa****1234</span>
                                        </li>
                                        <li>
                            ...
                            <div className='modal-white-card dash-border'>
                                ...
                                <ul>
                                    <li>
                                        <span className='cont-left'>Order Total</span>
                                        <span className='cont-right'>$1568.0</span>
                                    </li>
                                    <li>
                                        <span className='cont-left'>Taxes</span>
                                        <span className='cont-right'>$1.5</span>
                                    </li>
                                </ul>
                                </div>
...
export default CoinsAddedSuccessfully
