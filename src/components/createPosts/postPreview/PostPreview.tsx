...
import PuplishedPostSuccess from '@/components/modalcomponents/PuplishedPostSuccess';
     ...
     <div className='preview-post-sec mt-4 pb-4'>
        <div className='row justify-content-center'>
            <div className='col-xxl-4 col-lg-5 col-md-8'>
                ...
                <Link href="javascript:void(0)" className='w-100 btn-theme btn-yellow submit-btn mt-4' onClick={handlePostSuccess}>Publish</Link>
            </div>
        </div>
        <PuplishedPostSuccess show={showPostSuccess} handleClose={handleCloseAll}/>
    </div>
  )
}
