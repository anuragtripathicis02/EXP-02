                ...
                <div className='max-card my-auto'>
                    <div className='text-start'>
                        <div className='back-block text-start mb-4'>
                            <Link href="/authentication/signin" className='back-btn'>
                                <span className='icon'>
                    ...
                    <Link href="/discovermentorflow/discover">
                        ...
                        <p className='m-0'>By clicking, I accept EXP <Link href="/profileflow/termsConditions"
                            className='link-underline-text'> Term & Conditions,</Link>& <Link href="/profileflow/privacyPolicies"
                            className='link-underline-text'>Privacy Policy </Link> </p>
                    </div>
                   

                    <div className='create-account'>
                        <p className='m-0'>Already has an account?  <Link href="/authentication/signin"
