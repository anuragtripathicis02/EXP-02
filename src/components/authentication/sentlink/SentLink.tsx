    ...
    <div className='sec-email p-50 bg-img position-relative'>
                <div className='container position-relative z-1'>
                    <div className='mx-540 text-center'>
                        ...
                        <p className='mb-24'>We’ve sent a password reset link to your registered email: <b>da****ph@gmail.com</b>  Please check your inbox (and spam folder) to continue.</p>
                        ...
                        <p>
                            <Link href="/authentication/verifyemail" className='link-underline-text my-inbox'>
